      ...
      {inddata && Object.keys(inddata).length &&
        <div className='cart_container'>
          ...
          <div className='right_cart'>
            ...
            <p>You save : ₹570 (47%) : <span style={{ color: "#B12704" }}> ₹{inddata.price.mrp - inddata.price.cost} ({inddata.price.discount})</span></p>
            ...
            <p className='description'>About the Item :
              <span style={{ color: "#565959", fontSize: 14, fontWeight: 500, letterSpancing: 0.2 }}>
